<?php 
     foreach($sanpham_by_id as $key => $value) {
      $ten= $value['tenloai'];

    $hinh = $value['anhloaisp'];
 }
?>
<div class="container8">
    <div class="contain4">
        <div class="tenlistsanhpham">Trang chủ > <?php echo $ten ?></div>
        <div class="contain4">
            <!-- left -->
            <div class="listsanphamleft">
                ...
                <div class="boctinhtranglishlai">
                    <?php 
            $total=0;
            foreach($sanpham_by_id as $key => $sp){
        ...
        <div class="listsanphamright">
            <div class="tenvahinhanhlistsanpham">
                ...
                <div class="anhlistsanpham"><img
                        src="<?php echo BASE_URL ?>/public/uploads/loaisanpham/<?php echo $hinh?>"
                        class="anhlistsanpham1"></div>

                <div class="motalistsanpham"><?php echo $ten?></div>
